<template>
  <div class="container px-5 md:px-0 md:mx-auto about-us" data-aos="fade-down">
    <h1 class="font-soulmaze text-2xl md:text-4xl">About Us</h1>
    <h1 class="text-4xl md:text-6xl font-soulmaze-outline under-title opacity-40">About Us</h1>
